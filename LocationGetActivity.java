 ...
 */
public class LocationGetActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {

    private static final String TAG = LocationGetActivity.class.getSimpleName();
    ...
    private LocationUpdatesBroadcastReceiver locationReceiver;
    // UI Widgets.
    //private Button mRequestUpdatesButton;
    //private Button mRequestUpdatesButton;
    private SwitchCompat swchLocationOn;
    private TextView mLocationUpdatesResultView;
    public static boolean isUpdatesOn = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swchLocationOn = findViewById(R.id.swc_location_fetch);
        swchLocationOn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        locationReceiver = new LocationUpdatesBroadcastReceiver();
    ...
    protected void onResume() {
        ...
        //IntentFilter filter1 = new IntentFilter("hi_my_loc");
    ...
    private PendingIntent getPendingIntent() {
        ...
        /*Intent intentB = new Intent(this, LocationUpdatesBroadcastReceiver.class);
        intentB.setAction(LocationUpdatesBroadcastReceiver.ACTION_PROCESS_UPDATES);
        return PendingIntent.getBroadcast(this, 0, intentB, PendingIntent.FLAG_UPDATE_CURRENT);*/
    }
    ...
    public void doThis(IntentServiceResult intentServiceResult) {
        if (intentServiceResult.getResult() == 101) {
            mLocationUpdatesResultView.setText(mLocationUpdatesResultView.getText().toString() + "\n" + intentServiceResult.getResultValue());
        }
    }
}